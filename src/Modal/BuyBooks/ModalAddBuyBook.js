...
function ModalAddBuyBook({ showModalAddBuyBook, setShowModalAddBuyBook, onAddSuccess }) {
    ...
    const fetchLocations = async () => {
        try {
            ...
            setFilteredLocations(response.data.data); // Ban đầu hiển thị tất cả vị trí
        } catch (error) {
    ...
    const handleSearchBook = async (query) => {
        ...
        try {
            ...
            toast.success(`Đã chọn sách: ${book.tensach}`);
        } catch (error) {
    ...
    const handleSearchLocation = async (query) => {
        ...
        try {
            ...
            toast.success(`Đã chọn vị trí: ${location.mavitri}`);
        } catch (error) {
