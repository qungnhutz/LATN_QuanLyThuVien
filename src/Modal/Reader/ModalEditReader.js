...
function ModalEditReader({ showModalEditReader, setShowModalEditReader, readerData, onEditSuccess }) {
    ...
    useEffect(() => {
        if (readerData) {
            ...
            setBrithday(readerData.brithday ? readerData.brithday.split('T')[0] : '');
    ...
    const handleEditReader = async () => {
        try {
            ...
            console.log('Data to send:', dataToSend); // Debug dữ liệu gửi lên API
                                ...
                                <Form.Group controlId="formTypereader">
                                    ...
                                    <Form.Select
                                        ...
                                        onChange={(e) => {
                                            ...
                                            console.log('New typereader:', e.target.value); // Debug giá trị mới
                                        }}
                                        className="shadow-sm"
                                    >
